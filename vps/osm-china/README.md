...
- `public`：默认公共服务，任务总量上限固定为 10,000 km²，按不超过 750 km² 的分块受控续算，可覆盖标准 50 km 洪涝筛查圆。
...
5. 公共档位 10,000 km² 以上 AOI 会切换到受控重点筛查区或拒绝；`china_daily` 可按总量与单块阈值分批处理，但仍不得执行全国建筑和道路一次性全量普查。
